              ...
              <div className={styles.mockupDashboard}>
                <div className={styles.mockupContent}>
                  <div className={styles.mockupHeader}>
                    <h2 className={styles.mockupTitle}>Minhas Tarefas</h2>
                    <button className={styles.mockupAddButton}>
                      <span>+</span> Nova Tarefa
                    </button>
                  </div>
                  
                  <div className={styles.mockupTaskList}>
                    <div className={`${styles.mockupTask} ${styles.mockupTaskCompleted}`}>
                      <div className={styles.mockupCheckbox}></div>
                      <div className={styles.mockupTaskContent}>
                        <h3 className={styles.mockupTaskTitle}>Preparar apresentação do TCC</h3>
                        <div className={styles.mockupTaskDetails}>
                          <span className={styles.mockupTaskDate}>Hoje</span>
                          <span className={styles.mockupTaskCategory}>Estudos</span>
                        </div>
                      </div>
                    </div>
                    
                    <div className={styles.mockupTask}>
                      <div className={styles.mockupCheckbox}></div>
                      <div className={styles.mockupTaskContent}>
                        <h3 className={styles.mockupTaskTitle}>Revisar capítulo de metodologia</h3>
                        <div className={styles.mockupTaskDetails}>
                          <span className={styles.mockupTaskDate}>Amanhã</span>
                          <span className={styles.mockupTaskCategory}>TCC</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className={styles.mockupTask}>
                      <div className={styles.mockupCheckbox}></div>
                      <div className={styles.mockupTaskContent}>
                        <h3 className={styles.mockupTaskTitle}>Implementar sistema de gamificação</h3>
                        <div className={styles.mockupTaskDetails}>
                          <span className={styles.mockupTaskDate}>Quinta-feira</span>
                          <span className={styles.mockupTaskCategory}>Desenvolvimento</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className={styles.mockupTask}>
                      <div className={styles.mockupCheckbox}></div>
                      <div className={styles.mockupTaskContent}>
                        <h3 className={styles.mockupTaskTitle}>Reunião com orientador</h3>
                        <div className={styles.mockupTaskDetails}>
                          <span className={styles.mockupTaskDate}>Sexta-feira</span>
                          <span className={styles.mockupTaskCategory}>Reunião</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  
                  <div className={styles.mockupProgressSection}>
                    <h3 className={styles.mockupProgressTitle}>Progresso Semanal</h3>
                    <div className={styles.mockupProgressBar}>
                      <div className={styles.mockupProgressFill}></div>
                    </div>
                    <div className={styles.mockupProgressStats}>
                      <span>13 de 20 tarefas concluídas</span>
